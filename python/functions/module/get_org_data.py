    ...
    for data_from_org_unit in range(len(get_org_unit_data['organisationUnits'])):
        ...
        if('trackedEntityInstances' in get_tei_data):
            ...
            for number_of_tei in range(len(get_tei_data['trackedEntityInstances'])):
                ...
                new_data_array_Prescribed = {"tei": "", "program": "","stage":"","orgunit": "", "date": "", "m": "", "q": "", "m1": "", "q1": "", "m2": "",
                        "q2": "", "m3": "", "q3": "",
                        "m4": "", "q4": "", "m5": "", "q5": "", "m6": "", "q6": "", "m7": "", "q7": "", "m8": "",
                        "q8": "","last_update":""}
                new_data_array_Frequently = {"tei": "", "program": "","stage":"","orgunit": "", "date": "", "m10": "", "q10": ""
                        , "m11": "", "q11": "", "m12": "",
                        "q12": "", "m13": "", "q13": "",
                        ...
                        if(program_stage_type=="JV6n7FhC7xp"):
                            ...
                            for numberOfDataValue in range(len(get_event_id_data['dataValues'])):
                                ...
                                if event_id_data == "aM2Vn0UUPJB":
                                    ...
                                    new_data_array_Prescribed['m'] = get_code_data(event_value)
                                ...
                                if event_id_data == "HS5mppnnRUD":
                                    ...
                                    new_data_array_Prescribed['q'] = event_value
                        ...
                        if(program_stage_type=="tJQ1UCpkCy2"):
                            ...
                            for numberOfDataValue in range(len(get_event_id_data['dataValues'])):
                                ...
                                if event_id_data == "nTd67mb0PJe":
                                    event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                                    new_data_array_Frequently['m10'] = get_code_data(event_value)
                                if event_id_data == "g3jYfDWMlju":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m11'] = get_code_data("M-301-1001")
                                if event_id_data == "ezwWMPb12eO":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m12'] = get_code_data("M-123-1004")
                                if event_id_data == "iifVrszTRRz":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m13'] =  get_code_data("M-123-1018")
                                if event_id_data == "KIZvcIfQvpT":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m14'] = get_code_data("M-192-1010")
                                if event_id_data == "qs0I9NsfUxu":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m15'] = get_code_data("M-192-1035")
                                if event_id_data == "YxFGAkRihhj":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m16'] =  get_code_data("M-123-1030")
                                if event_id_data == "x2qkkLksG0N":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m17'] = get_code_data("M-123-1035")
                                if event_id_data == "uuaO52vR7Sc":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m18'] = get_code_data("M-192-1016")
                                if event_id_data == "cgKw0UiSSzA":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m19'] =  get_code_data("M-192-1012")
                                if event_id_data == "A0WmBW0xr3Q":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m20'] =  get_code_data("M-121-1020")
                                if event_id_data == "igbaI5cMEch":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m21'] = get_code_data("M-123-1041")
                                if event_id_data == "tXnR137oYs6":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m22'] =  get_code_data("M-251-4012")
                                if event_id_data == "joyfXYlQ0aS":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m23'] =  get_code_data("M-251-4013")
                                if event_id_data == "Oh5NachZvua":
                                    if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                                        new_data_array_Frequently['m24'] =  get_code_data("M-181-1018")
                ...
                #     event_id = event_data['events'][number_of_event]['event']
                #     orgunit = event_data['events'][number_of_event]['orgUnit']
                #     new_data_array['program'] = event_data['events'][number_of_event]['program']
                #     new_data_array['orgunit'] = orgunit
                #     print(event_id)
                #     # ----> Get all data for every event
                #     get_event_id_data = json.loads(get_event_data(event_id))
                #     new_data_array['date'] = str(datetime.strptime(get_event_id_data['eventDate'], '%Y-%m-%dT%H:%M:%S.%f').date())
                #     new_data_array['last_update'] = str(datetime.strptime(get_event_id_data['dueDate'], '%Y-%m-%dT%H:%M:%S.%f').date())
                ...
                #             if event_id_data == "aM2Vn0UUPJB":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m'] = get_code_data(event_value)
                #             if event_id_data == "WSeukMBwbQ3":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m1'] = get_code_data(event_value)
                #             if event_id_data == "TORfS27wR0q":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m2'] = get_code_data(event_value)
                #             if event_id_data == "TnrWDEL4PoR":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m3'] = get_code_data(event_value)
                #             if event_id_data == "iy166uomfXk":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m4'] = get_code_data(event_value)
                #             if event_id_data == "ntECq4xEo24":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m5'] = get_code_data(event_value)
                #             if event_id_data == "Ne2veOUhPw0":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m6'] = get_code_data(event_value)
                #             if event_id_data == "R2rxr1Z8i4v":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m7'] = get_code_data(event_value)
                #             if event_id_data == "Dlx79ePwf1g":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m8'] = get_code_data(event_value)
                #             if event_id_data == "oTCRn8enMzd":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m9'] = get_code_data(event_value)
                #             if event_id_data == "nTd67mb0PJe":
                #                 event_value = get_event_id_data['dataValues'][numberOfDataValue]['value']
                #                 new_data_array['m10'] = get_code_data(event_value)
                #             if event_id_data == "g3jYfDWMlju":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m11'] = get_code_data("M-301-1001")
                #             if event_id_data == "ezwWMPb12eO":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m12'] = get_code_data("M-123-1004")
                #             if event_id_data == "iifVrszTRRz":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m13'] =  get_code_data("M-123-1018")
                #             if event_id_data == "KIZvcIfQvpT":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m14'] = get_code_data("M-192-1010")
                #             if event_id_data == "qs0I9NsfUxu":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m15'] = get_code_data("M-192-1035")
                #             if event_id_data == "YxFGAkRihhj":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m16'] =  get_code_data("M-123-1030")
                #             if event_id_data == "x2qkkLksG0N":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m17'] = get_code_data("M-123-1035")
                #             if event_id_data == "uuaO52vR7Sc":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m18'] = get_code_data("M-192-1016")
                #             if event_id_data == "cgKw0UiSSzA":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m19'] =  get_code_data("M-192-1012")
                #             if event_id_data == "A0WmBW0xr3Q":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m20'] =  get_code_data("M-121-1020")
                #             if event_id_data == "igbaI5cMEch":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m21'] = get_code_data("M-123-1041")
                #             if event_id_data == "tXnR137oYs6":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m22'] =  get_code_data("M-251-4012")
                #             if event_id_data == "joyfXYlQ0aS":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m23'] =  get_code_data("M-251-4013")
                #             if event_id_data == "Oh5NachZvua":
                #                 if get_event_id_data['dataValues'][numberOfDataValue]['value']:
                #                     new_data_array['m24'] =  get_code_data("M-181-1018")
                #             if event_id_data == "HS5mppnnRUD":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q'] = event_value
                #             if event_id_data == "Kzxa8SKjCdp":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q1'] = event_value
                #             if event_id_data == "wmkND48fkvf":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q2'] = event_value
                #             if event_id_data == "sm78nae74E0":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q3'] = event_value
                #             if event_id_data == "YR7bARfLBay":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q4'] = event_value
                #             if event_id_data == "Pl3jCeEVYVG":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q5'] = event_value
                #             if event_id_data == "J6s8Ju9Y1xk":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q6'] = event_value
                #             if event_id_data == "xFAUNJilvDg":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q7'] = event_value
                #             if event_id_data == "tn3XjDR6aUt":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q8'] = event_value
                #             if event_id_data == "H2g1tcKI0sK":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q9'] = event_value
                #             if event_id_data == "wFeFcxSnOO0":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q10'] = event_value
                #             if event_id_data == "gTreHa9FsAJ":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q11'] = event_value
                #             if event_id_data == "nubIuNPn6kP":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q12'] = event_value
                #             if event_id_data == "UOVMe9Hftr8":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q13'] = event_value
                #             if event_id_data == "cMVX1z75Uvh":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q14'] = event_value
                #             if event_id_data == "B3rbznpTyjJ":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q15'] = event_value
                #             if event_id_data == "nxfbinD79RB":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q16'] = event_value    
                #             if event_id_data == "BIP1buozD2e":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q17'] = event_value
                #             if event_id_data == "xGxzPWNaSuz":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q18'] = event_value
                #             if event_id_data == "Fe9k17OVHPe":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q19'] = event_value     
                #             if event_id_data == "wiLMg4LNV3V":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q20'] = event_value     
                #             if event_id_data == "z8F0ZEgFeeY":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q21'] = event_value     
                #             if event_id_data == "btTycEIdfBr":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q22'] = event_value     
                #             if event_id_data == "vO16pLLv3u8":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q23'] = event_value     
                #             if event_id_data == "mIKc81UxFte":
                #                 event_value = int(
                #                     get_event_id_data['dataValues'][numberOfDataValue]['value'])
                #                 new_data_array['q24'] = event_value          
                # # newest_data.append(new_data_array)
